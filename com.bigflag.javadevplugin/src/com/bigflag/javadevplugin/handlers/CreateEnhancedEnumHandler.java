 ...
 */
public class CreateEnhancedEnumHandler extends AbstractHandler {
	/**
	 * The constructor.
	 */
	public CreateEnhancedEnumHandler() {
	}
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		try {
			...
			String fluentApiBean=DevTools.createEnhancedEnum(fileContent);
